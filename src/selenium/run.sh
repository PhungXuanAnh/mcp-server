...
export PYTHONPATH="/home/xuananh/Downloads/servers/src/selenium/src:$PYTHONPATH"

# Change to the fetch source directory
cd /home/xuananh/Downloads/servers/src/selenium/src

# Activate the virtual environment and run the module
source /home/xuananh/Downloads/servers/.venv/bin/activate
/home/xuananh/Downloads/servers/.venv/bin/python -m mcp_server_selenium "$@"